...
!
MODULE WAMINTGR_CUDA_MOD
CONTAINS
SUBROUTINE WAMINTGR_CUF(CDTPRA, CDATE, CDATEWH, CDTIMP, CDTIMPNEXT, BLK2GLO, WVENVI, WVPRPT, FF_NOW, FF_NEXT, INTFLDS,  &
& WAM2NEMO, MIJ, FL1, XLLWS)
  ...
  USE YOWSTAT, ONLY: CDTPRO, IDELPRO, IDELT, IDELWI, LLSOURCE, TIME_PHYS, TIME_PROPAG, &
  & TIME_PHYS_KERNEL
...
!$acc data deviceptr(FL1_DPTR,XLLWS_DPTR,MIJ_DPTR,WAVNUM_DPTR,CGROUP_DPTR,CIWA_DPTR,CINV_DPTR,XK2CG_DPTR,STOKFAC_DPTR,&
...
END SUBROUTINE WAMINTGR_CUF
END MODULE WAMINTGR_CUDA_MOD
